          ...
          builder: (_, AsyncSnapshot<int> index) {
            ...
            return BottomNavigationBar(
              ...
              items: <BottomNavigationBarItem>[
                ...
                BottomNavigationBarItem(
                  tooltip: " My Orders",
                  icon: _navIcon(KImages.orders, textColor),
                  activeIcon: _navIcon(KImages.ordersAct, primaryColor),
                  label: 'My Orders',
                ),
                BottomNavigationBarItem(
                  tooltip: 'My Wallet',
                  icon: _navIcon(KImages.wallet, textColor),
                  activeIcon: _navIcon(KImages.walletAct, primaryColor),
                  label: 'My Wallet',
                ),
                BottomNavigationBarItem(
                  tooltip: 'Profile',
