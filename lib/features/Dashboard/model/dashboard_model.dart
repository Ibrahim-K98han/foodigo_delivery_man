...
class DashboardModel extends Equatable {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'recent_orders': activeOrder!.map((x) => x.toMap()).toList(),
          ...
          map['recent_orders'] != null
              ? List<ActiveOrder>.from(
                (map['recent_orders']['data'] as List<dynamic>)
                    .map<ActiveOrder?>(
                      (x) => ActiveOrder.fromMap(x as Map<String, dynamic>),
                    ),
              )
              : null,
      withdrawHistory:
...
class DeliveryMan extends Equatable {
  ...
  @override
  List<Object> get props {
    return [id, name, email, phone, image];
  }
}
...
class OrderStatistics extends Equatable {
  ...
  @override
  List<Object> get props {
    return [request, running, completed, cancelled, total];
  }
}
...
class ActiveOrder extends Equatable {
  ...
  factory ActiveOrder.fromJson(String source) =>
      ActiveOrder.fromMap(json.decode(source) as Map<String, dynamic>);
